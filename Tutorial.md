...
We will use a simple python flask web application for the tutorial, you can download the source code from [GitHub](https://github.com/nholuongut/devops-for-ai-apps).
